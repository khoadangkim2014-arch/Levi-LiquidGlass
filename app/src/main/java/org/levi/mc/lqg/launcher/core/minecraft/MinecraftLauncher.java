                        ...
                        if (major < 1 || (major == 1 && minor < 21) || (major == 1 && minor == 21 && patch < 80)) {
                            activity.runOnUiThread(() -> {
                                new org.levimc.launcher.ui.dialogs.CustomAlertDialog(activity)
                                        .setTitleText(activity.getString(org.levi.mc.lqg.R.string.unsupported_version_title))
                                        .setMessage(activity.getString(org.levi.mc.lqg.R.string.unsupported_version_msg))
                                        .setPositiveButton(activity.getString(org.levi.mc.lqg.R.string.back), null)
                                        .show();
                            });
