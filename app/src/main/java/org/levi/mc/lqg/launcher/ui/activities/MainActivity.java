     ...
     private void setupOnBackPressedCallback() {
         onBackPressedCallback = new OnBackPressedCallback(true) {
             ...
             public void handleOnBackPressed() {
                 ...
                 exitDialog.setTitleText(getString(org.levi.mc.lqg.R.string.dialog_title_exit_app))
                         .setMessage(getString(org.levi.mc.lqg.R.string.dialog_message_exit_app))
                         .setPositiveButton(getString(org.levi.mc.lqg.R.string.dialog_positive_exit), v -> {
                             exitDialog.dismissImmediately();
                             finishAffinity();
                         })
                         .setNegativeButton(getString(org.levi.mc.lqg.R.string.dialog_negative_cancel), null)
                         .show();
             }
         };
